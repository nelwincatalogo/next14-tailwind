  ...
  return (
    <main className="bg-gray-200 font-sans">
      <div className="flex min-h-screen flex-col items-center justify-center gap-4">
        ...
        <div className="mt-4 rounded-full bg-gray-300 px-4 py-1 text-xs">Available Fonts</div>
        ...
        <div className="mt-4 rounded-full bg-gray-300 px-4 py-1 text-xs">Toast Example</div>
        <ReactAlertSample />
      </div>
    </main>
  );
